...
│   ├── south_america_cropwat_example.py  # Rio de la Plata workflow script
│   ├── arizona_usda_scs_example.py   # Arizona USDA-SCS workflow script
│   ├── AZ.geojson              # Arizona boundary GeoJSON
│   ├── RioDelaPlata/          # Rio de la Plata region outputs
│   │   ├── RDP_ERA5Land/         # ERA5-Land outputs
│   │   ├── RDP_TerraClimate/     # TerraClimate outputs
...
│       ├── AZ_GridMET_USDA_SCS/  # GridMET U.S. dataset outputs
│       ├── AZ_PRISM_USDA_SCS/    # PRISM U.S. dataset outputs
│       ├── AZ_ERA5Land_USDA_SCS/ # ERA5-Land global dataset outputs
│       ├── AZ_TerraClimate_USDA_SCS/ # TerraClimate global dataset outputs
...
- **`south_america_cropwat_example.py`**: A comprehensive Python script demonstrating the complete pyCropWat workflow including data processing, temporal aggregation, statistical analysis, visualization (including anomaly, climatology, and trend maps), and dataset comparison using real Rio de la Plata data.
- **`arizona_usda_scs_example.py`**: A U.S.-focused workflow demonstrating the USDA-SCS method with GridMET/PRISM precipitation and SSURGO AWC for Arizona, with U.S. vs Global dataset comparisons.
...
ep = EffectivePrecipitation(
    ...
    end_year=2020,
    precip_scale_factor=1000,
    method='fao_aglw'  # Options: 'cropwat', 'fao_aglw', 'fixed_percentage', 'dependable_rainfall', 'farmwest', 'usda_scs'
)
...
| `--method` | - | No | cropwat | Peff method: cropwat, fao_aglw, fixed_percentage, dependable_rainfall, farmwest, usda_scs |
...
📖 **Script:** `Examples/south_america_cropwat_example.py`
...
python south_america_cropwat_example.py --gee-project your-project-id --workers 8

# Force reprocess all data from GEE
python south_america_cropwat_example.py --force-reprocess --gee-project your-project-id --workers 8
```
...
📖 **Script:** `Examples/arizona_usda_scs_example.py`
...
<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/time_series.png" width="48%" alt="Time Series">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/monthly_climatology.png" width="48%" alt="Monthly Climatology">
</p>
...
<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/map_2023_06.png" width="32%" alt="Winter Map">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/map_2023_01.png" width="32%" alt="Summer Map">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/map_notable_2015_12.png" width="32%" alt="El Niño Event">
</p>
...
<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/comparisons/comparison_2023_06.png" width="100%" alt="Side-by-side Comparison">
</p>

*Side-by-side comparison of ERA5-Land and TerraClimate effective precipitation with difference map.*

<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/comparisons/scatter_comparison.png" width="48%" alt="Scatter Plot">
  <img src="Examples/RioDelaPlata/analysis_outputs/comparisons/annual_comparison.png" width="48%" alt="Annual Comparison">
</p>

*Left: Scatter plot comparison with R², RMSE, and bias statistics. Right: Annual totals comparison.*

<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/comparisons/zonal_comparison.png" width="70%" alt="Zonal Comparison">
</p>
...
<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/anomaly_map_2023_01.png" width="32%" alt="Anomaly Map">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/climatology_map_01.png" width="32%" alt="Climatology Map">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/trend_map_with_significance.png" width="32%" alt="Trend Map">
</p>
...
<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/figures/ERA5Land/trend_maps.png" width="70%" alt="Trend Panel">
</p>
...
<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/method_comparison/ERA5Land_method_maps_2020_01.png" width="100%" alt="Method Comparison Maps">
</p>

*Comparison of effective precipitation methods: CROPWAT, FAO/AGLW, Fixed Percentage (70%), Dependable Rainfall (75%), and FarmWest.*

<p align="center">
  <img src="Examples/RioDelaPlata/analysis_outputs/method_comparison/ERA5Land_method_curves.png" width="60%" alt="Method Curves">
</p>
...
The Arizona workflow ([Examples/arizona_usda_scs_example.py](Examples/arizona_usda_scs_example.py)) demonstrates U.S.-specific datasets with the USDA-SCS method:

#### Time Series & Climatology

<p align="center">
  <img src="Examples/Arizona/analysis_outputs/figures/GridMET/time_series.png" width="48%" alt="Arizona Time Series">
  <img src="Examples/Arizona/analysis_outputs/figures/GridMET/monthly_climatology.png" width="48%" alt="Arizona Climatology">
</p>
...
<p align="center">
  <img src="Examples/Arizona/analysis_outputs/figures/GridMET/anomaly_map_2023_08.png" width="32%" alt="Arizona Anomaly">
  <img src="Examples/Arizona/analysis_outputs/figures/GridMET/climatology_map_08.png" width="32%" alt="Arizona Climatology Map">
  <img src="Examples/Arizona/analysis_outputs/figures/GridMET/trend_map_with_significance.png" width="32%" alt="Arizona Trend">
</p>
...
<p align="center">
  <img src="Examples/Arizona/analysis_outputs/figures/GridMET/trend_maps.png" width="70%" alt="Arizona Trend Panel">
</p>
...
<p align="center">
  <img src="Examples/Arizona/analysis_outputs/us_vs_global/multi_dataset_summary.png" width="70%" alt="U.S. vs Global">
</p>
