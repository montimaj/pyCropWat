...
Examples:
  ...
  pycropwat aggregate --input ./output --type climatology \\
    ...
    agg_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
...
Examples:
  ...
  pycropwat analyze zonal --input ./output --zones ./regions.shp \\
    ...
    anomaly_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    ...
    trend_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    ...
    zonal_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
...
Examples:
  ...
  pycropwat export cog --input ./output/effective_precip_2020_06.tif --output ./cog_2020_06.tif
    ...
    netcdf_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
...
Examples:
  ...
  pycropwat plot annual-compare --input ./era5_output --other-input ./terraclimate_output \\
    ...
    ts_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    ...
    clim_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    ...
    map_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    ...
    interactive_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    ...
    compare_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    compare_parser.add_argument('--other-pattern', default='effective_precip_*.tif', help='Pattern for secondary dataset')
    ...
    scatter_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    scatter_parser.add_argument('--other-pattern', default='effective_precip_*.tif', help='Pattern for secondary dataset')
    ...
    annual_compare_parser.add_argument('--pattern', default='effective_precip_*.tif', help='File glob pattern')
    annual_compare_parser.add_argument('--other-pattern', default='effective_precip_*.tif', help='Pattern for secondary dataset')
